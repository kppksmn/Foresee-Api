...
### 1. รองรับการกรองรายการงานด้วยวันที่นัดหมาย (Scheduled Date Filter)
...
### 2. บล็อกการมอบหมายงานให้คนขับที่ใบขับขี่หมดอายุ (License Expiration Assignment Blocking)
- `src/API/APIs/v1/Admin/AdminEndpoints.cs`:
...
### 3. ถอด `nameEn` / `name_en` ออกจากระบบ 100%
...
### 4. ลบเมนูแผนที่ติดตาม (`/map`) & Seed Data
- `src/Infrastructure/Data/DbInitializer.cs`: ลบเมนู `แผนที่ติดตาม` (`/map`) ออกจาก SQL Seed Menu Data

### 5. ระบบป้องกันการลบเมนูหลักของระบบ (System Menu Protection)
